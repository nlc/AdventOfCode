...
test_counts_a = part_a(test_raw_adapters)
test_ans_a = test_counts_a.values.inject(:*)
puts "  TEST:   #{test_counts_a} --> \033[1m#{test_ans_a}\033[0m"
...
puts "  TEST:   \033[1m#{part_b(test_raw_adapters)}\033[0m"
